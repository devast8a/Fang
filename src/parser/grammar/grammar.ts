...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "ExprIdentifier", "symbols": ["Identifier"], "postprocess": p.ExprIdentifier},
    ...
    {"name": "EcArgument", "symbols": ["Identifier", "_", {"literal":":"}, "_", "Expr"], "postprocess": p.PExprArgument},
    ...
    {"name": "EnArgument", "symbols": ["Identifier", "_", {"literal":":"}, "_", "Expr"], "postprocess": p.PExprArgument},
    ...
    {"name": "ExprMacroCall", "symbols": ["EmTarget", "CompileTime", "ExprMacroCall$ebnf$1"], "postprocess": p.ExprMacroCall},
    ...
    {"name": "StmtForEach", "symbols": ["SfKeyword", "StmtForEach$ebnf$1", "SfCondition", "SfBody"], "postprocess": p.StmtForEach},
    ...
    {"name": "StmtIf", "symbols": ["SiKeyword", "SiCondition", "SiBody", "StmtIf$ebnf$1", "StmtIf$ebnf$2"], "postprocess": p.StmtIf},
    ...
    {"name": "StmtMatch", "symbols": ["SmKeyword", "SmValue", "SmCases"], "postprocess": p.StmtMatch},
    ...
    {"name": "StmtReturn", "symbols": ["SrKeyword", "StmtReturn$ebnf$1"], "postprocess": p.StmtReturn},
    ...
    {"name": "StmtWhile", "symbols": ["SwKeyword", "StmtWhile$ebnf$1", "SwCondition", "SwBody"], "postprocess": p.StmtWhile},
