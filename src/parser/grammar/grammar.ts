...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "DeclClass", "symbols": ["DcKeyword", "DcName", "DeclClass$ebnf$1", "DeclClass$ebnf$2", "DeclClass$ebnf$3", "DeclClass$ebnf$4"], "postprocess": p.PDeclStruct},
    {"name": "DcKeyword", "symbols": [{"literal":"struct"}, "__"]},
    ...
    {"name": "DcBody$macrocall$1$macrocall$3", "symbols": ["N_"]},
    ...
    {"name": "DeclEnum$ebnf$1", "symbols": ["DeBody"], "postprocess": id},
    {"name": "DeclEnum$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "DeclEnum", "symbols": ["DeKeyword", "DeName", "DeclEnum$ebnf$1"], "postprocess": p.PDeclEnum},
