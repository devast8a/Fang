...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "expression_cf_if$ebnf$1", "symbols": []},
    {"name": "expression_cf_if$ebnf$1", "symbols": ["expression_cf_if$ebnf$1", "eci_elif"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "expression_cf_if$ebnf$2", "symbols": ["eci_else"], "postprocess": id},
    {"name": "expression_cf_if$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "expression_cf_if", "symbols": ["eci_keyword", "eci_condition", "eci_body", "expression_cf_if$ebnf$1", "expression_cf_if$ebnf$2"], "postprocess": p.If},
    {"name": "stmt", "symbols": ["expression_cf_if"]},
    {"name": "eci_keyword", "symbols": [{"literal":"if"}, "_"]},
    {"name": "eci_condition", "symbols": [{"literal":"("}, "_", "expr", "_", {"literal":")"}, "_"]},
    {"name": "eci_body$macrocall$2", "symbols": ["stmt"]},
    {"name": "eci_body$macrocall$1$macrocall$2", "symbols": [{"literal":"{"}]},
    {"name": "eci_body$macrocall$1$macrocall$3", "symbols": ["eci_body$macrocall$2"]},
    {"name": "eci_body$macrocall$1$macrocall$4", "symbols": ["__"]},
    {"name": "eci_body$macrocall$1$macrocall$5", "symbols": [{"literal":"}"}]},
    {"name": "eci_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1", "symbols": []},
    {"name": "eci_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1$subexpression$1", "symbols": ["eci_body$macrocall$1$macrocall$4", "eci_body$macrocall$1$macrocall$3"]},
    {"name": "eci_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1", "symbols": ["eci_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1", "eci_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "eci_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1", "symbols": ["eci_body$macrocall$1$macrocall$3", "eci_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1", "_"]},
    {"name": "eci_body$macrocall$1$macrocall$1$ebnf$1", "symbols": ["eci_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "eci_body$macrocall$1$macrocall$1$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "eci_body$macrocall$1$macrocall$1", "symbols": ["eci_body$macrocall$1$macrocall$2", "_", "eci_body$macrocall$1$macrocall$1$ebnf$1", "eci_body$macrocall$1$macrocall$5"]},
    {"name": "eci_body$macrocall$1", "symbols": ["eci_body$macrocall$1$macrocall$1"]},
    {"name": "eci_body", "symbols": ["eci_body$macrocall$1"], "postprocess": p.STAR},
    {"name": "eci_elif", "symbols": ["_", {"literal":"else"}, "__", {"literal":"if"}, "_", "eci_condition", "_", "eci_body"]},
    {"name": "eci_else", "symbols": ["_", {"literal":"else"}, "_", "eci_body"]},
    {"name": "expression_cf_while", "symbols": ["ecw_keyword", "ecw_condition", "ecw_body"], "postprocess": p.While},
    {"name": "stmt", "symbols": ["expression_cf_while"]},
    {"name": "ecw_keyword", "symbols": [{"literal":"while"}, "_"]},
    {"name": "ecw_condition", "symbols": [{"literal":"("}, "_", "expr", "_", {"literal":")"}, "_"]},
    {"name": "ecw_body$macrocall$2", "symbols": ["stmt"]},
    {"name": "ecw_body$macrocall$1$macrocall$2", "symbols": [{"literal":"{"}]},
    {"name": "ecw_body$macrocall$1$macrocall$3", "symbols": ["ecw_body$macrocall$2"]},
    {"name": "ecw_body$macrocall$1$macrocall$4", "symbols": ["__"]},
    {"name": "ecw_body$macrocall$1$macrocall$5", "symbols": [{"literal":"}"}]},
    {"name": "ecw_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1", "symbols": []},
    {"name": "ecw_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1$subexpression$1", "symbols": ["ecw_body$macrocall$1$macrocall$4", "ecw_body$macrocall$1$macrocall$3"]},
    {"name": "ecw_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1", "symbols": ["ecw_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1", "ecw_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "ecw_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1", "symbols": ["ecw_body$macrocall$1$macrocall$3", "ecw_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1$ebnf$1", "_"]},
    {"name": "ecw_body$macrocall$1$macrocall$1$ebnf$1", "symbols": ["ecw_body$macrocall$1$macrocall$1$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "ecw_body$macrocall$1$macrocall$1$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "ecw_body$macrocall$1$macrocall$1", "symbols": ["ecw_body$macrocall$1$macrocall$2", "_", "ecw_body$macrocall$1$macrocall$1$ebnf$1", "ecw_body$macrocall$1$macrocall$5"]},
    {"name": "ecw_body$macrocall$1", "symbols": ["ecw_body$macrocall$1$macrocall$1"]},
    {"name": "ecw_body", "symbols": ["ecw_body$macrocall$1"], "postprocess": p.STAR},
