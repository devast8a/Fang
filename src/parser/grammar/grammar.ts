...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "ExprBinary", "symbols": ["ExprUnary", "__", "OperatorSpaced", "__", "ExprBinary"]},
    {"name": "ExprBinary", "symbols": ["Atom", "Operator", "Atom"]},
    {"name": "ExprBinary", "symbols": ["ExprUnary"]},
    {"name": "ExprUnary", "symbols": ["Operator", "Atom"]},
    {"name": "ExprUnary", "symbols": ["Atom", "Operator"]},
    ...
    {"name": "ExprCall", "symbols": ["EcTarget", "EcArguments"], "postprocess": p.ExprCall},
