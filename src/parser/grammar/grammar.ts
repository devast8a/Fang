...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "main$subexpression$1$ebnf$1$subexpression$1", "symbols": ["StmtSep", "Stmt"]},
    {"name": "main$subexpression$1$ebnf$1", "symbols": ["main$subexpression$1$ebnf$1", "main$subexpression$1$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "main$subexpression$1$ebnf$2", "symbols": ["NL"], "postprocess": id},
    {"name": "main$subexpression$1$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "main$subexpression$1", "symbols": ["Stmt", "main$subexpression$1$ebnf$1", "main$subexpression$1$ebnf$2"]},
    {"name": "main", "symbols": ["main$ebnf$1", "main$subexpression$1"], "postprocess": function(data){ return [].concat(...data[0]); }},
    ...
    {"name": "DfGeneric", "symbols": ["NL", "DeclGeneric"]},
    {"name": "DfAttribute", "symbols": ["NL", "Attribute"]},
    {"name": "DfBody$ebnf$1", "symbols": ["NL"], "postprocess": id},
    {"name": "DfBody$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "DfBody$macrocall$2", "symbols": ["Stmt"]},
    {"name": "DfBody$macrocall$1$macrocall$2", "symbols": [{"literal":"{"}]},
    {"name": "DfBody$macrocall$1$macrocall$3", "symbols": ["NL"]},
    ...
    {"name": "DfBody", "symbols": ["DfBody$ebnf$1", "DfBody$macrocall$1"]},
    ...
    {"name": "DcBody$macrocall$1$macrocall$3", "symbols": ["NL"]},
    ...
    {"name": "ExprConstruct", "symbols": ["EnTarget", "EnArguments"]},
    {"name": "EnTarget$ebnf$1", "symbols": ["CompileTime"], "postprocess": id},
    {"name": "EnTarget$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "EnTarget", "symbols": ["Atom", "EnTarget$ebnf$1"]},
    ...
    {"name": "SfBody$macrocall$1$macrocall$3", "symbols": ["NL"]},
    ...
    {"name": "SwBody$macrocall$1$macrocall$3", "symbols": ["NL"]},
    ...
    {"name": "SiBody$macrocall$1$macrocall$3", "symbols": ["NL"]},
    ...
    {"name": "SmCases$macrocall$1$macrocall$3", "symbols": ["NL"]},
    ...
    {"name": "SmBody$macrocall$1$macrocall$3", "symbols": ["NL"]},
