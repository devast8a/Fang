...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "DeKeyword", "symbols": [{"literal":"enum"}]},
    {"name": "DeName", "symbols": ["__", "Identifier"]},
    ...
    {"name": "DeclParameter", "symbols": ["DeclParameter$ebnf$1", "DpName", "DeclParameter$ebnf$2", "DeclParameter$ebnf$3", "DeclParameter$ebnf$4", "DeclParameter$ebnf$5"], "postprocess": p.PDeclParameter},
    ...
    {"name": "ExprLogical", "symbols": ["ExprBinaryA"]},
    {"name": "ExprLogical", "symbols": ["ExprLogical", "__", {"literal":"or"}, "__", "ExprBinaryA"], "postprocess": p.PExprBinary},
    {"name": "ExprLogical", "symbols": ["ExprLogical", "__", {"literal":"and"}, "__", "ExprBinaryA"], "postprocess": p.PExprBinary},
    {"name": "ExprBinaryA", "symbols": ["ExprBinaryB"]},
    {"name": "ExprBinaryA", "symbols": ["ExprBinaryA", "__", "OperatorSpaced", "__", "ExprBinaryB"], "postprocess": p.PExprBinary},
    ...
    {"name": "ExprList$macrocall$3", "symbols": ["N_"]},
    ...
    {"name": "ExprList", "symbols": ["ExprList$macrocall$1"], "postprocess": p.PLiteralList},
    ...
    {"name": "Break", "symbols": [{"literal":"break"}], "postprocess": p.Break},
    {"name": "Stmt", "symbols": ["Break"]},
    ...
    {"name": "ExprIndexBracket", "symbols": ["EbTarget", "EbIndex"], "postprocess": p.PExprIndexBracket},
    ...
    {"name": "ExprMove", "symbols": ["ExprMoveKeyword", "ExprMoveExpr"], "postprocess": p.PExprMove},
    {"name": "ExprMoveKeyword", "symbols": [{"literal":"move"}, "__"]},
    {"name": "ExprMoveExpr", "symbols": ["Atom"]},
    {"name": "Atom", "symbols": ["ExprMove"]},
    ...
    {"name": "SfCondition", "symbols": ["_", "Identifier", "__", {"literal":"in"}, "__", "Expr"]},
    ...
    {"name": "SwCondition", "symbols": ["_", "Expr"]},
